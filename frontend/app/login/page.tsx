...
const getApiBase = () => {
  if (typeof window !== "undefined") {
    // In browser — use the env variable or fall back to same origin
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          <div className="space-y-4">
            {mode === "signup" && (
              <>
                ...
                <div>
                  ...
                  <input type="text" placeholder="Acme Corp" value={form.org_name}
            ...
            <button onClick={handleSubmit} disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 text-white font-medium py-2.5 rounded-lg text-sm mt-2">
        ...
        <p className="text-center text-xs text-gray-700 mt-6">Free plan · No credit card required</p>
      </div>
    </div>
  );
}